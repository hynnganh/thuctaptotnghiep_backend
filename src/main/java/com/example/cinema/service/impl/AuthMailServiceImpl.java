...
public class AuthMailServiceImpl implements AuthMailService {
    ...
    public void sendOtpEmail(String toEmail, String otpCode) {
        try {
            ...
            helper.setFrom("huynhthingocanh2008@gmail.com", "HNA CINEMA Security");            
            helper.setTo(toEmail);
            helper.setSubject("HNA CINEMA - MÃ XÁC THỰC QUÊN MẬT KHẨU");
            ...
            content.append("<div style='font-size: 10px; font-weight: 900; letter-spacing: 5px; color: #dc2626; text-transform: uppercase; margin-bottom: 8px;'>HNA CINEMA SECURITY</div>");
            ...
            content.append("<p style='color: #9ca3af; font-size: 14px; margin-bottom: 30px; line-height: 1.6;'>Chúng tôi nhận được yêu cầu khôi phục mật khẩu cho tài khoản của bạn tại hệ thống <strong>HNA CINEMA</strong>. Dưới đây là mã xác thực (OTP) của bạn:</p>");
            ...
            content.append("<p style='margin: 0 0 4px 0;'>HỆ THỐNG BẢO MẬT TÀI KHOẢN HNA CINEMA</p>");
